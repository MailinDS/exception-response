// miniprogram/pages/receiveList/receiveList.js
const app = getApp()
...
Page({
  ...
  getTotal: function () {
    var that = this
    db.collection('exception').where(db.command.or([
      {
        dutyDepart: app.globalData.department
      },
      {
  ...
  showDetail: function(e) {
    wx.navigateTo({
      url: '../exceptionDetail/exceptionDetail?id=' + e.currentTarget.dataset.exceptionId,
    })
  },
